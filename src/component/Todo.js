...
const Todo = ({ todo }) => {
    ...
    return (
        ...
        >
            ...
            <div onClick={() => handleColorSelect(id, "red")} className={`flex-shrink-0 h-4 w-4 rounded-full border-2 ml-auto cursor-pointer border-red-500 hover:bg-red-500 ${color === 'red' && 'bg-red-500'}`}></div>
